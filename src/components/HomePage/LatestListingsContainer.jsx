...
export default function LatestListingsContainer({ latestListings }) {
  ...
  return (
    <div className="container-sm mt-4 latest-listing-container">
      <div className="row mb-3 pt-2">
        <div className="col-9">
          <h6>Latest Listings</h6>
        </div>
        <div className="col-2 mb-1 d-flex flex-row-reverse">
          <button type="button" className="btn btn-sm  font-italic see-more" onClick={handleSeeMore}>{seeMoreButtonName}</button>
        </div>
      </div>
